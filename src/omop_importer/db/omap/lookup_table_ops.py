...
from ..utils.column_ops import create_destination_column, create_table_for_column
from ..utils.delete_ops import drop_table
from ..utils.indexing_ops import add_index
from ..utils.query_utils import execute_query, execute_many_query
...
def _insert_data(cursor, conn, lookup_table_files, destination_table):
    for lookup_table_file in lookup_table_files:
        with open(lookup_table_file, "r", encoding="utf-8", newline="") as file:
