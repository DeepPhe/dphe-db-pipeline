from ..db.utils.column_ops import change_column_type, create_table_for_column, add_column, get_column_type, \
    update_column_with_join, \
    insert_single_column_from_muitlple_columns, update_single_column
from ..db.omap.icd_ops import process_icd_operation, update_calculated_dx_data
...
def process_age_at_operation(cursor, conn, config):
    ...
    birth_table = operation['birth_table']
