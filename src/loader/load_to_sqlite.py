...
def _build_compressor(algo: str, level: int):
    ...
    if algo == 'lz4':
        ...
        return 'lz4', None, (lambda b: __import__('lz4.frame').frame.compress(b, compression_level=level))
...
def load_files_to_db(input_dir: str, db_path: str, recursive: bool = True, zip_file: str = None, zipdir: str = None, num_processes: int = 12, compress: str = 'zstd', level: int = 1, min_compress_bytes: int = 512, vacuum: bool = False):
    """
    ...
    if zipdir:
        ...
        print("\nAggregating results...")
        for zip_loaded, zip_errors, zip_bytes, zip_name in results:
