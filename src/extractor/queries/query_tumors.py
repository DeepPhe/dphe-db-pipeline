...
def list_tumor_types(db_path: str, pattern: str = None):
    """
...
Examples:
  ...
  python query_tumors.py Adenocarcinoma --negated
    ...
    parser.add_argument(
        '--db',
        type=str,
        default='deepphe/deepphe_sqlite_compressed',
        help='Path to database (default: deepphe/deepphe_sqlite_compressed)'
    )
