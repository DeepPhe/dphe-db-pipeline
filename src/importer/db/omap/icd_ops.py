...
def create_icd_lookup_table(cursor, conn, icd9=False, icd10=False):
    ...
    unique_brcaova_hosp_codes = get_unique_matching_icd_codes(
        cursor,
        table_name="omap.DIAGNOSIS_BRCAOVCA_HOSP_VW",
    ...
    unique_brcaova_outpt_codes = get_unique_matching_icd_codes(
        cursor,
        table_name="omap.DIAGNOSIS_BRCAOVCA_OUTPT_VW",
        column_name="CONDITION_SOURCE_VALUE",
        icd_vocab=vocab,
        substring_char=":",
        index=-1,
    ...
    unique_melanoma_hosp_codes = get_unique_matching_icd_codes(
        cursor,
        table_name="omap.DIAGNOSIS_MELANOMA_HOSP_VW",
        column_name="CONDITION_SOURCE_VALUE",
        icd_vocab=vocab,
        substring_char=":",
        index=-1,
    ...
    unique_melanoma_outpt_codes = get_unique_matching_icd_codes(
        cursor,
        table_name="omap.DIAGNOSIS_MELANOMA_OUTPT_VW",
        column_name="CONDITION_SOURCE_VALUE",
        icd_vocab=vocab,
        substring_char=":",
        index=-1,
...
def process_icd_operation(cursor, conn, config):
    """
    Build CALCULATED_PT_ICD_CODES from configured OMAP diagnosis source tables.
